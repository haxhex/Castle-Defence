...
public class Main extends Application {
    ...
    public static void save() {
        stopGame();
        try {
            File file = new File("G:\\991\\AP-WORKS-991\\Castle--Defence-master\\saved\\players");
        ...
        try {
            File file = new File("G:\\991\\AP-WORKS-991\\Castle--Defence-master\\saved\\saved\\map");
            FileOutputStream fileOutputStream = new FileOutputStream(file);
            ObjectOutputStream objectOutputStream = new ObjectOutputStream(fileOutputStream);
    ...
    public static void load() {
        ...
        try {
            File file = new File("G:\\991\\AP-WORKS-991\\Castle--Defence-master\\saved\\map");
            FileInputStream fileInputStream = new FileInputStream(file);
            ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream);
